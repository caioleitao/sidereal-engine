...
class Vector3 {
    ...
    applyMatrix4(m) {
        const x = this.x, this.y, z = this.z;
        const e = m.elements;
    ...
    clampLenght(min, max) {
        ...
        return this.divideScalar(lenght || 1).multiplyScalar(Math.max(min, Math.min(max, lenght)));
    ...
    setFromMatrixScale(m) {
        ...
        const sz = this.setFromMatrixColumn(m,2).elngth();
